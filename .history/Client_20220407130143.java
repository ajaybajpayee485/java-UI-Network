  ...
  private void handleEvents() {
    messagTextField.addKeyListener(new KeyListener(){
      ...
      public void keyReleased(KeyEvent e) {
        //System.out.println("Key released " +e.getKeyCode())if();
        if(e.getKeyCode()==10){
          //System.out.println("you entered enter button");
          String contentTosend=messagTextField.getText();
          messageArea.append("Me: "+contentTosend);
          out.println(contentTosend);
          out.flush();
          messagTextField.setText("");
          messagTextField.requestFocus();
        }
   ...
   public void startReading()
    {
      Runnable r1=()->{
          ...
          if(msg.equals("exit")){
              ...
              messagTextField.setEnabled(false);
              socket.close();
              break;
